/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+css-extras+go&plugins=file-highlight+show-language+inline-color+data-uri-highlight+toolbar+copy-to-clipboard */
var _self =
  ...
  if ("undefined" != typeof self && self.Prism && self.document) {
    ...
    var e = !(o.plugins.fileHighlight = {
      highlight: function (e) {
        for (
          var t, i = (e || document).querySelectorAll(d), n = 0;
          (t = i[n++]);
